...
urlpatterns = [
    ...
    path('check_heath/', views.check_heath, name="check_heath"),
    ...
    # path("add-like/<int:id>/", views.add_to_wishlist, name="add-like"),

    #URL for Products
    path('product/<slug:slug>/', views.detail, name="product-detail"),
    path('blog/<slug:slug>/', views.detail_blog, name="blog-detail"),
