...
from .models import Address, Category, Like, Product, Cart, Order, Blog
...
class BlogAdmin(admin.ModelAdmin):
    list_display = ('title', 'slug', 'blog_image', 'is_featured', 'updated_at')
    list_editable = ('slug', 'blog_image', 'is_featured')
    list_filter = ( 'title','is_featured')
    list_per_page = 10
    search_fields = ('title', 'is_featured')
    prepopulated_fields = {"slug": ("title", )}
